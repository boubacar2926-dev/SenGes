    ...
    <div class="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-gray-900 px-6">
        <div class="max-w-md w-full bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg border border-gray-300 dark:border-gray-700 transition-transform transform hover:scale-105 duration-300">
            ...
            <form method="POST" action="{{ route('register') }}" class="mt-6">
                ...
                <div class="mb-4 relative">
                    ...
                    <div class="relative">
                        ...
                        <span class="absolute inset-y-0 right-3 flex items-center cursor-pointer" onclick="togglePassword('password', 'eyeIcon1')">
                            <svg id="eyeIcon1" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-600 dark:text-gray-300" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div class="mb-4 relative">
                    ...
                    <div class="relative">
                        ...
                        <span class="absolute inset-y-0 right-3 flex items-center cursor-pointer" onclick="togglePassword('password_confirmation', 'eyeIcon2')">
                            <svg id="eyeIcon2" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-600 dark:text-gray-300" viewBox="0 0 20 20" fill="currentColor">
                                <path d="M10 3C5 3 1 8 1 10s4 7 9 7 9-5 9-7-4-7-9-7zm0 12c-3 0-6-3.5-6-5s3-5 6-5 6 3.5 6 5-3 5-6 5zm0-8a3 3 0 110 6 3 3 0 010-6z" />
                            </svg>
                        </span>
                    </div>
                ...
                <button type="submit"
                    class="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 rounded-lg shadow-md transition duration-300 transform hover:scale-105">
                    🚀 S'inscrire
                </button>
            </form>
